...
(function () {
  ...
  function initNav() {
    document.addEventListener('click', function (e) {
      ...
      if (pageId === 'post' && postSlug) {
        showPage('post', postSlug);
      } else if (pageId) {
        showPage(pageId);
      }
    });
  ...
  var POSTS = [
    {
      ...
      excerpt_en: 'The mind doesn\'t run to the phone because the phone is interesting. It runs because the present is too quiet — and quiet feels strange.',
      featured: true,
      glyph: '◯'
    },
    {
    ...
    },
    {
      ...
      num: '04',
      tag_vn: 'Thực hành 5 phút',
      tag_en: '5-min practice',
